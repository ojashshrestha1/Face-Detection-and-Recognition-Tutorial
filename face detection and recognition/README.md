...
2. In Visual Studio Code, open a new Terminal, type **git clone https://github.com/ojashshrestha1/Face-Detection-and-Recognition-Tutorial.git ** and select *enter*. 
